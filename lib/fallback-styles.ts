...
.landing-layout,.project-layout,.wizard-layout,.writing-layout,.outline-layout,.project-page-grid,.project-grid,.capability-board,.hero-stats,.metric-grid,.progress-card,.form-grid,.chapter-studio{display:grid;gap:1.25rem}
...
.hero-panel,.project-main,.single-panel-page,.stack-list,.risk-list,.outline-list,.capability-list,.workbench-stack,.chapter-menu,.chapter-panel{display:grid;gap:1rem}
...
.hero-card h1,.page-intro h1,.sidebar-project h1,.project-hero h2,.content-card h3,.form-card h2,.content-card h4{text-wrap:balance}
.hero-card h1{margin:.35rem 0 0;font-size:clamp(2.28rem,4.4vw,3.5rem);line-height:1.08;letter-spacing:-.04em;max-width:13ch}
.page-intro h1,.sidebar-project h1{margin:.35rem 0 0;font-size:clamp(1.72rem,2.4vw,2.28rem);line-height:1.12;letter-spacing:-.04em}
...
.project-card h3,.choice-card__title{margin:0;font-size:1.14rem;font-weight:700;line-height:1.24}
...
@media (max-width:1180px){
 ...
 .project-hero,.grid-header,.helper-banner,.page-intro,.section-ribbon,.hero-card__top,.site-header,.site-header__right,.card-heading{flex-direction:column;align-items:flex-start}
